	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			if(bDisplaySetButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonSet btn btn-primary'>" + oDTP.settings.setButtonContent + "</a>";
			if(bDisplayClearButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonClear btn btn-danger'>" + oDTP.settings.clearButtonContent + "</a>";
