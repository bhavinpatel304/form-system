                                    ...
                                    <div class="form-edtior w-100 cursor-pointer">
                                       ...
                                       <div class="question_editable">
                                          <div class="question">
                                             ...
                                             <div class="inputBox">
                                                <input class="form-control" name="chkboxarr[]" value="" placeholder="Enter an answer choice" type="text" data-validation="required" data-validation-error-msg-container="dropdownarr_error" data-validation-error-msg="You have to agree to our terms">
                                             </div>
